...
@property (readwrite, nonatomic, assign) NSInteger    fag;
...
+ (instancetype)menuItem:(NSString *)title image:(UIImage *)image tag:(NSInteger)tag fag:(NSInteger)fag userInfo:(NSDictionary *)userInfo;
