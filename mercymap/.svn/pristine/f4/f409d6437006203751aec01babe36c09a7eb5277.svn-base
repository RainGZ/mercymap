...
- (UIView *) mkContentView {
    ...
    const CGFloat imagex = kMarginX *2 + titleWidth;
...
//            const CGRect imageFrame;
            CGRect imageFrame;
            if (menuItem.fag==1) {
            imageFrame =(CGRect){kMarginX * 2, kMarginY, maxImageWidth, maxItemHeight - kMarginY * 2};
            }
            else{
                imageFrame =(CGRect){imagex,kMarginY,maxImageWidth,maxItemHeight - kMarginY * 2};
            }
